...
parser.add_argument("mesh", type=str, description="FEniCS mesh file")
parser.add_argument("image", type=str, description="Nifti file to get transformation matrix from")
parser.add_argument("surface", type=str, description="Freesurfer surface file to get shift of mesh")
parser.add_argument("output", type=str, description="File to save the function to (e.g. shear_modulus.pvd)")
parser.add_argument(
